 ...
 * @Last Modified time: 2020-04-24 14:00:58
 */
class AndroidAd {
    /**记录当前奖励类型*/
    ...
    public static Splash() {
        let obj = App.ins().getAd(0)
        let dataFromJs = JSON.stringify({ type: obj })
        //开屏广告
        Openadsdk.SplashAd(() => { }, this, dataFromJs);
    }
